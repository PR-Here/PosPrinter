package com.pankajrana.poslibrary.bluetooth;
...
import com.pankajrana.poslibrary.R;
...
public abstract class SearchPrinterDialog {
    ...
    public SearchPrinterDialog(Activity activity, BTService service) {
        ...
        View view = LayoutInflater.from(activity).inflate(R.layout.search_dialog_layout, null, false);
